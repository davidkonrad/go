...
//http://plnkr.co/edit/Tsqkv1nd6CC8e5Kr9pdU?p=preview
angular.module('gulveonlineApp').directive('readMore', function() {
  return {
    restrict: 'A',
    transclude: true,
    replace: true,
    ...
    link: function(scope, elem, attr, ctrl, transclude) {
			alert('ok');
      var moreText = angular.isUndefined(scope.moreText) ? ' <a class="read-more">Læs mere...</a>' : ' <a class="read-more">' + scope.moreText + '</a>',
        lessText = angular.isUndefined(scope.lessText) ? ' <a class="read-less">Læs mindre^</a>' : ' <a class="read-less">' + scope.lessText + '</a>',
